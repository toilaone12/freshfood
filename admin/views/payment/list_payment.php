                ...
                <div class="card">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="?action=edit-payment&id=<?php echo $list['id_payment']?>" class="btn btn-success">
                                <i class="fa-solid fa-pen-to-square"></i>
                              </a>
                              <a href="?action=delete-payment&id=<?php echo $list['id_payment']?>" class="btn btn-danger">
