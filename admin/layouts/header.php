...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">FreshFood</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?action=list-account" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách tài khoản</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?action=insert-account" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?action=list-category" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách danh mục</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?action=insert-category" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm danh mục</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?action=list-product" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách sản phẩm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?action=insert-product" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm sản phẩm</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?action=list-slide" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách quảng cáo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?action=insert-slide" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm quảng cáo</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?action=list-role" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách quyền quản lý</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?action=insert-role" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm quyền quản lý</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?action=list-payment" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách phương thức</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?action=insert-payment" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
